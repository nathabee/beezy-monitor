...
This guide describes how to publish **Beezy Monitor** to the **Chrome Web Store**.
...
* Homepage URL (for example: `https://nathabee.github.io/beezy-monitor/`)
* Support URL (for example: `https://github.com/nathabee/beezy-monitor/issues`)
