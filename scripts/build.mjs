...
function copyStatic({ isDev }) {
  ...
  // devtools files
  copyFile(path.join(root, "src/devtools/devtools.html"), path.join(distDir, "devtools/devtools.html"));

  // panel files (used as the DevTools panel UI)
...
const entryPoints = {
  ...
  devtools: path.join(root, "src/devtools/devtools.ts"),
};
...
async function runWatch() {
  ...
  watchIfExists(path.join(root, "src/devtools"), { recursive: true }, () => copyStatic({ isDev }));
