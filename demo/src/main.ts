...
function getBasePath(): string {
  ...
  // - "./" becomes something like "/beezy-monitor-demo/" at runtime when served from that folder
  // - on GitHub pages it becomes "/repo/beezy-monitor-demo/"
...
async function boot() {
  const root = document.getElementById("beezy-monitor-demo-root");
  if (!root) throw new Error("Missing #beezy-monitor-demo-root");
